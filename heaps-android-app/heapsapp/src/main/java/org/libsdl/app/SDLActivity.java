        ...
        if (mNextNativeState == NativeState.RESUMED) {
            if (mSurface.mIsSurfaceReady && mHasFocus && mIsResumedCalled) {
                if (mSDLThread == null) {
                    ...
                    mSDLThread = new Thread(new SDLMain(() -> mSingleton.run()), "SDLThread");
...
class SDLMain implements Runnable {
    private final Runnable additionalRunnable;

    SDLMain(Runnable additionalRunnable) {
        this.additionalRunnable = additionalRunnable;
    }
